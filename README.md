...
| 6-1 高斯消元法 | 原理 | - |
| 6-2 高斯-约旦消元法 | 原理 | - |
| 6-3 实现高斯-约旦消元法 | 实现 | [Python](06-Linear-System/03-Implement-Gauss-Jordan-Elimination/) |
| 6-4 线性方程组的解的结构 | 原理 | - |
| 6-5 实现更一般化的高斯-约旦消元法 | 实现 | [Python] |
| 6-6 线性系统与矩阵的逆 | 原理 | - |
| 6-7 实现矩阵的逆的求解 | 实现 | [Python] |
| 6-8 初等矩阵 | 原理 | - |
| 6-9 矩阵的LU分解 | 原理 | - |
| 6-10 实现矩阵的LU分解 | 实现 | [Python] |
| 6-11 更多线性系统相关话题 | 原理 | - |
