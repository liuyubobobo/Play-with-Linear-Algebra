...
| 5-4 单位矩阵和矩阵的逆 | 原理 | - |
| 5-5 实现单位矩阵和numpy中矩阵的逆 | 实现 | [Python](04-Implement-Identity-Matrix-and-Inverse-of-a-Matrix-in-Numpy/) |
| 5-6 矩阵的逆的性质 | 原理 | - |
| 5-7 看待矩阵的另一个视角：坐标变换 | 原理 | - |
| 5-8 再看矩阵乘法 | 原理 | - |
| 5-9 矩阵在图论中的应用 | 原理 | - |
| 5-10 实现矩阵的幂 | 实现 | [Python] |
| 5-11 总结：看待矩阵的四个重要视角 | 原理 | - |
| **第六章 线性系统** | - | [章节文件夹] |
| 6-1 高斯消元法 | 原理 | - |
